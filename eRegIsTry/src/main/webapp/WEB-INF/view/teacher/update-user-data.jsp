...
<html>
<head>
    <title>Update Teacher (user data)</title>
...
<form:form action="/teacher/update-user-data" method="POST" modelAttribute="user">
    ...
    <input type="submit" value="Update user" name="submitBtn" />
</form:form>
</div>
</body>
</html>
