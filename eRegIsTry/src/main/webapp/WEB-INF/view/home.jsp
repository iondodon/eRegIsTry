...
<div class="menu">
    ...
    <div>
        <p>News!</p>
        <br>
        <h1>STUDENTS’ SELECTION CONTEST FOR ICM WITHIN ERASMUS+ PROGRAMME IN POLAND
        <br>
...
<br>
      <h1>  21.11.2019 – 27.11.2019 – REGISTRATION based on the candidature application. CONSULTATION regarding the preparation of the application</h2>
<br>
